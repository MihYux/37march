...
export interface RegionWorkspace {
  ...
  planReleases: Array<{ id: string; batchId: string; experimentId: string; regionId: string; taskId: string; rolloutPercent: number; status: "published"; publishedAt: string }>;
  aiDeliveries: Array<{
